...
public class MultiPartGsonRequest<T> extends Request<T> implements MultiPartRequest {
     ...
     */
    public MultiPartGsonRequest(int method, String url, Class<T> objectClass, Listener<T> listener, ErrorListener errorListener) {
    ...
    protected Response<T> parseNetworkResponse(NetworkResponse response) {
        ...
        VolleyLog.d("Url: " + this.getUrl() + "  " + this.getStringUploads());
        VolleyLog.d("statusCode " + response.statusCode + " : " + parsed);
